...
;
	...
	window["_c2hh_"] = "C526BDA66AA5489745CF814DB7BC046F4190F500";
...
;
;
cr.plugins_.TextBoxTwo = function(runtime)
{
	this.runtime = runtime;
};
(function ()
{
	var pluginProto = cr.plugins_.TextBoxTwo.prototype;
	var textcuted = 1;
	var textadded = 1;
	pluginProto.Type = function(plugin)
	{
	...
	instanceProto.onCreate = function()
	{
		...
		this.elem.style.fontSize = this.properties[10]+"px";
		this.elem.style.color = this.properties[11];
		this.elem.style.background = this.properties[12];
		this.elem.style.borderRadius = this.properties[13]+"px";
		this.elem.style.outline = (this.properties[14] === 0);
		this.elem.class = this.properties[16];
		this.elem.maxLength = this.properties[17];
		if (this.properties[7] === 7)	// block
		{
		this.elem.style.border = "none";
		this.elem.style.outline = "none";
		this.elem.style.background = "rgba(98, 135, 167, 0)";
		this.elem["readOnly"] = "Yes";
		}
		...
		var onchangetrigger = (function (self) {
			return function() {
				self.runtime.trigger(cr.plugins_.TextBoxTwo.prototype.cnds.OnTextChanged, self);
			};
		})(this);
		...
		this.elem.onclick = (function (self) {
			return function(e) {
				...
				self.runtime.trigger(cr.plugins_.TextBoxTwo.prototype.cnds.OnClicked, self);
		...
		this.elem.ondblclick = (function (self) {
			return function(e) {
				e.stopPropagation();
				self.runtime.isInUserInputEvent = true;
				self.runtime.trigger(cr.plugins_.TextBoxTwo.prototype.cnds.OnDoubleClicked, self);
				self.runtime.isInUserInputEvent = false;
			};
		})(this);
	...
	Cnds.prototype.IsClassText = function (classtextf)
	{
		if(this.elem.class == classtextf)
			return true;
	};
	Cnds.prototype.IsIdText = function (idtextf)
	{
		if(this.elem.id == idtextf)
			return true;
	};
	Cnds.prototype.OnTextCut = function ()
	{
		if(textcuted == 0){
			textcuted = 1;
			return true;
	...
	Cnds.prototype.OnTextAdd = function ()
	{
		if(textadded == 0){
			textadded = 1;
			return true;
	...
	Acts.prototype.ScrollToTop = function ()
	{
		if (this.runtime.isDomFree)
			return;
		this.elem.scrollTop = 0;
	};
	Acts.prototype.ScrollTo = function (scrolln)
	{
		if (this.runtime.isDomFree)
			return;
		var scrollprocent = this.elem.scrollHeight/100*scrolln;
		this.elem.scrollTop = scrollprocent;
	};
	Acts.prototype.AddText = function (addtextstring)
	{
		if (this.runtime.isDomFree)
			return;
		this.elem.value = this.elem.value + addtextstring;
		textadded = 0;
	};
	Acts.prototype.SetId = function (settextstring)
	{
		if (this.runtime.isDomFree)
			return;
		this.elem.id = settextstring;
	};
	Acts.prototype.SetClass = function (settextstring)
	{
		if (this.runtime.isDomFree)
			return;
		this.elem.class = settextstring;
	};
	Acts.prototype.CutText = function (cuttextstring)
	{
		if (this.runtime.isDomFree)
			return;
		var textforcut;
		textforcut = this.elem.value;
		this.elem.value = textforcut.replace(cuttextstring, "");
		textcuted = 0;
	};
	pluginProto.acts = new Acts();
	function Exps() {};
	...
	Exps.prototype.Class = function (ret)
	{
		...
		ret.set_string(this.elem.class);
	};
	Exps.prototype.Amount = function (ret)
	{
		var lngt = this.elem.value;
		var nubmlnght = lngt.length;
		var u5236 = nubmlnght + "";
		ret.set_string(u5236);
	};
	pluginProto.exps = new Exps();
}());
;
;
cr.plugins_.trblsm_table = function(runtime) {
    this.runtime = runtime;
};
(function() {
    Extend(cr.plugins_.trblsm_table.prototype, new PluginClass());
	...
	this.InstanceObject = function() {
	    this.storage = {};
	    this.list_count = 0;
	    this.field_count = function(list) {
		var count = 0;
		if (isset(this.storage[list])) {
		    for (var i in this.storage[list]) {
	    ...
	    this.Get = function(list, field) {
		if (isset(this.storage[list]) && isset(this.storage[list][field])) {
		    return(this.storage[list][field]);
		} else {
		    return(0);
		}
	    }
	    this.SetValue = function(list, field, value) {
		if (isset(this.storage[list]) === false) {
		    this.storage[list] = {};
		    this.list_count++;
		}
		this.storage[list][field] = value;
	    }
	    this.Merge = function(JSONString, list) {
		...
		for (var y in data) {
			...
			for (var z in data[y]) {
			    var value = data[y][z];
			    this.SetValue(y, z, value);
			}
		    } else {
			var value = data[y];
			this.SetValue(list, y, value);
		    }
		}
	    }
	    ...
	    this.GetListObject = function(list) {
		this.ClearNulls();
		if (isset(this.storage[list])) {
		...
		if (this.deletePending) {
			...
			if (this.storage[i] === null) {
			    ...
			    for (var field in this.storage[i]) {
				if(this.storage[i][field] === null){
				    delete this.storage[i][field];
				}
			    }
			}
		    }
	...
	this.cnds = new function() {
		...
		for (var i in this.storage) {
		    ...
		    this.runtime.pushCopySol(this.runtime.getCurrentEventStack().current_event.solModifiers);
		    this.runtime.getCurrentEventStack().current_event.retrigger();
		    this.runtime.popSol(this.runtime.getCurrentEventStack().current_event.solModifiers);
		}
		this.cur_for.clear();
		return false;
	    }
	    this.ForEachListWhere = function(field, expression, value) {
		var current_event = this.runtime.getCurrentEventStack().current_event;
		var x = 1;
		for (var i in this.storage) {
		    if (this.cur_for.stopLoop) {
		    ...
		    if (this.compareValue(this.storage[i][field], expression, value) === false) {
			continue;
		    }
		    this.cur_for.listName = i;
		    this.cur_for.loopIndex = x++;
		...
		return this.compareValue(this.Get(list, field), expression, value);
	    }
	    this.ForEachField = function(list) {
		if (isset(this.storage[list]) === false) {
		    this.cur_for.clear();
		    return false;
		}
		...
		for (var i in this.storage[list]) {
		    ...
		    if (this.storage[list][i] === null) {
			this.cur_for.clear();
			continue;
		    }
		    this.cur_for.loopIndex = x++;
		    this.cur_for.field = i;
		    this.cur_for.fieldValue = this.storage[list][i];
		    this.runtime.pushCopySol(current_event.solModifiers);
		    current_event.retrigger();
		    this.runtime.popSol(current_event.solModifiers);
		}
	    ...
	    this.ForEachFieldWhere = function(list, expression, value) {
		if (isset(this.storage[list]) === false) {
		    this.cur_for.clear();
		    return false;
		}
		...
		for (var i in this.storage[list]) {
		    ...
		    if (this.compareValue(this.storage[list][i], expression, value) === false) {
			continue;
		    }
		    this.cur_for.loopIndex = x++;
		    this.cur_for.field = i;
	    ...
	    this.CompareListCount = function(expression, count) {
		return this.compareValue(this.list_count, expression, count);
	    }
	    this.CompareFieldCount = function(list, expression, count) {
		return this.compareValue(this.field_count(list), expression, count);
	    }
	    this.CompareFieldValue = function(list, field, expression, value) {
		return this.compareValue(this.Get(list, field), expression, value);
	    }
	    this.WhereListKey = function(expression, list) {
		var current_event = this.runtime.getCurrentEventStack().current_event;
		var x = 1;
		for (var i in this.storage) {
		    if (this.cur_for.stopLoop) {
		    ...
		    if (isset(this.storage[i]) == false) {
			continue;
		    }
		    if (expression == 0 && i != list) {
			continue;
		    }
		    if (expression == 1 && i == list) {
			continue;
		    }
		    this.cur_for.listName = i;
		    this.cur_for.loopIndex = x++;
	...
	this.acts = new function() {
	    this.SetValue = function(list, field, value) {
		this.SetValue(list, field, value);
	    }
	    this.AddToValue = function(list, field, value) {
		if (isset(this.storage[list]) && isset(this.storage[list][field])) {
		    this.storage[list][field] = this.storage[list][field] + value;
		} else {
		    this.SetValue(list, field, value);
		}
	    }
	    this.SubFromValue = function(list, field, value) {
		if (isset(this.storage[list]) && isset(this.storage[list][field])) {
		    this.storage[list][field] = this.storage[list][field] - value;
		} else {
		    this.SetValue(list, field, -value);
	    ...
	    this.DeleteField = function(list, field) {
		if (isset(this.storage[list]) && isset(this.storage[list][field])) {
		    this.storage[list][field] = null;
	    ...
	    this.MergeToTable = function(JSONString) {
		this.Merge(JSONString);
	    }
	    this.MergeToList = function(JSONString, list) {
		this.Merge(JSONString, list);
	    }
	    this.LoadToList = function(JSONString, list) {
		this.storage[list] = JSON.parse(JSONString);
	    }
	    this.MergeDictionaryToList = function(JSONString, list) {
		var data = json_decode(JSONString);
		this.Merge(json_encode(data['data']), list);
	    }
	    ...
	    this.SortListByValue = function(list, ASC) {
		ASC = ASC == 0 ? true : false;
		var listObject = this.GetListObject(list);
		var sortObject = {}
		var x = 0;
		...
		this.ClearList(list);
		for (var i in listObject) {
		    this.SetValue(list, listObject[i]['key'], listObject[i]['value']);
		}
	    }
	    this.SortListByField = function(list, ASC) {
		ASC = ASC == 0 ? true : false;
		var listObject = this.GetListObject(list);
		var sortObject = {}
		var x = 0;
		...
		listObject = this.sort(sortObject, 'key', ASC);
		this.ClearList(list);
		for (var i in listObject) {
		    this.SetValue(list, listObject[i]['key'], listObject[i]['value']);
		}
	    }
	    this.SortTable = function(field, ASC) {
		ASC = ASC == 0 ? true : false;
		...
		this.ClearTable();
		for (var i in tableObject) {
		    this.Merge(tableObject[i]['data'], tableObject[i]['key'])
		}
	    }
	    this.Get = function(list, field) {
		this.cur_get = this.Get(list, field);
	    }
	    this.ListAsDictionaryJSON = function(list) {
		this.cur_get = json_encode({"c2dictionary": true, "data": this.GetListObject(list)});
	    }
	}
	this.exps = new function() {
	    this.Get = function(ret, list, field) {
		ret.set_any(this.Get(list, field));
	    }
		...
		ret.set_any(isset(this.storage[listName][field]) ? this.storage[listName][field] : 0);
	    };
	    ...
	    this.ListCount = function(ret) {
		ret.set_int(this.list_count);
	    };
	    this.FieldCount = function(ret, list) {
		ret.set_int(this.field_count(list));
	    };
	    this.AsJSON = function(ret) {
		ret.set_string(JSON.stringify(this.GetTableObject()));
	    };
	    this.ListAsJSON = function(ret, list) {
		ret.set_string(JSON.stringify(this.GetListObject(list)));
	    };
	    this.ListAsDictionaryJSON = function(ret, list) {
		ret.set_string(json_encode({"c2dictionary": true, "data": this.GetListObject(list)}));
	    }
...
cr.getObjectRefTable = function () { return [
	...
	cr.plugins_.TextBoxTwo,
	cr.plugins_.trblsm_table,
	cr.system_object.prototype.cnds.OnLayoutStart,
	cr.plugins_.AJAX.prototype.acts.Request,
	cr.plugins_.AJAX.prototype.cnds.OnComplete,
	cr.plugins_.trblsm_table.prototype.acts.MergeToTable,
	cr.plugins_.AJAX.prototype.exps.LastData,
	cr.system_object.prototype.acts.SetVar,
	cr.plugins_.trblsm_table.prototype.exps.Get,
	cr.plugins_.TextBoxTwo.prototype.acts.SetText
];};
