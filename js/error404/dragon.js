...
function handleMouseUp(event) {
  ...
  powerField.innerHTML = 'score: '+parseInt(sneezingRate*100/maxSneezingRate);
...
var h1 = canvas.getElementsByTagName('h1')[0];

var h1content = document.createElement('h1');
h1content.classList.add('oldbrowser');
h1content.innerHTML = 'Your browser does not appear to support HTML5.  Try upgrading your browser to the latest version.  <a href="http://outdatedbrowser.com">New browsers.</a>\n' +
  '\t\t\t<br><br><a href="http://www.microsoft.com/windows/internet-explorer/default.aspx">Microsoft Internet Explorer</a><br>\n' +
  '\t\t\t<a href="http://www.mozilla.com/firefox/">Mozilla Firefox</a><br>\n' +
  '\t\t\t<a href="http://www.google.com/chrome/">Google Chrome</a><br>\n' +
  '\t\t\t<a href="http://www.apple.com/safari/download/">Apple Safari</a>';

canvas.insertBefore(h1content, h1);
